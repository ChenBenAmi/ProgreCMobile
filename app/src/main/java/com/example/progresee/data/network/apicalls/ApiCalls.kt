...
interface ApiCalls {
    ...
    fun updateClassroomAsync(@Header("Authorization") token: String, @Query("classroomId")classroomId:String,@Query("name") name:String): Deferred<Response<Map<String,Classroom>>>
